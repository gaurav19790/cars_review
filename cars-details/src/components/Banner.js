...
<div>
<button type='button' className='z-20 absolute top-32 left-12 bg-gray-400 p-1 rounded-lg'  onClick={showPrevImage}>{"<"}</button>
  <button type='button' className='z-20 absolute top-32 right-12 bg-gray-400 p-1 rounded-lg '  onClick={showNextImage}>{">"}</button>
